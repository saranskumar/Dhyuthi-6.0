          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
              ...
              <div className='bg-black/40 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-500/20'>
                <div className='text-center'>
                  <div className="relative aspect-[3/4] rounded-xl overflow-hidden mb-6">
                      <Image
                        src="/synkron.jpg"          // replace with your poster
                        alt="TRACK1 Poster"
                        fill
            ...
            <div className='text-white'>
              ...
              <p className='text-xl mb-8 mt-6 text-purple-200 leading-relaxed'>
                Dive into the world of autonomous vehicles with a fully immersive, hands-on workshop where you’ll design, assemble, and program your own self-driving car. This is your first step into AI-powered robotics and intelligent control systems.
              </p>
              ...
              <a
                href='https://dhyuthi.ieeesctsb.org/synkron/reg'
      ...
      <div id="abt1" className='max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-purple-200 max-w-3xl mx-auto'>
            SYNKRON is a three-day challenge-driven workshop that takes you from concept to competition. Learn the core principles of computer vision, real-time decision-making, and embedded control, then build an ESP32-powered self-driving car capable of navigating a live test track.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-16'>
          <div className='bg-black/40 backdrop-blur-md p-8 rounded-xl shadow-lg hover:shadow-purple-500/30 transition-shadow duration-300 border border-purple-500/10'>
           ...
           Gain insights from industry mentors and research experts in robotics, AI, and embedded systems who will guide you through every stage of autonomous vehicle development — from perception to control.
            </p>
          </div>
          ...
          <div className='bg-black/40 backdrop-blur-md p-8 rounded-xl shadow-lg hover:shadow-purple-500/30 transition-shadow duration-300 border border-purple-500/10'>
            ...
            <p className='text-purple-200'>
            Build your own driver from scratch: assemble the chassis, integrate sensors, code the control loops, and deploy vision-based navigation. Test your bot in a live-track performance challenge to prove its speed, accuracy, and agility.
            </p>
          </div>
          ...
          <div className='bg-black/40 backdrop-blur-md p-8 rounded-xl shadow-lg hover:shadow-purple-500/30 transition-shadow duration-300 border border-purple-500/10'>
            ...
            <p className='text-purple-200'>
            Collaborate with like-minded innovators, engineers, and tech enthusiasts passionate about AI, robotics, and IoT. Build valuable connections that can accelerate your future projects and career.
            </p>
          </div>
        </div>
      </div>
