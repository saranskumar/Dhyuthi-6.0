            ...
            <form onSubmit={handleSubmit} className="space-y-8 text-white">
                ...
                <>
                  ...
                  <div className="text-center mb-6">
                    <p className="mb-4 text-purple-200">
                      ...
                      <br />
                      After paying, upload the payment screenshot for
                      verification.
                    </p>
                    <Image
                      src="/placeholder-qr.png"
                      alt="Payment QR Code"
                      className="mx-auto w-64 h-64 border-2 border-purple-500 rounded-xl shadow-lg"
                    />
                  </div>
                  <div>
              ...
              <div className="flex justify-between mt-6">
                ...
                <button
                  ...
                  className="ml-auto inline-flex items-center bg-gradient-to-r from-purple-600 to-purple-800 px-8 py-3 rounded-2xl font-bold hover:from-purple-700 hover:to-purple-900 transform hover:scale-105 transition-all duration-300 shadow-lg"
                >
