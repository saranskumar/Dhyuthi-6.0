      ...
      <div className="md:w-[80%] m-3 mt-16 justify-center items-center">
        ...
        <div className="max-w-[1380px] mx-auto grid lg:grid-cols-2 gap-8 ">
          <div className="w-full  flex flex-col p-4 my-16 rounded-lg hover:scale-105 duration-300 ">
            ...
            <button  onClick={() => window.open("https://your-link-here.com", "_blank")} className="bg-gradient-to-r from-[#623e94] via-[#5519a7] to-[#9348fc] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-white">
           Register Now
            </button>
          </div>
